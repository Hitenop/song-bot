...
def a(client, message):
    ...
    try:
        ...
        rep = f'🎶 <b>Title:</b> <a href="{link}">{title}</a>\n⌚ <b>Duration:</b> <code>{duration}</code>\n📻 <b>Uploaded By:</b> <a href="https://t.me/request_moviesorseries">Rp songs bot</a>'
        ...
        m.edit('**An internal Error Occured, Report This @request_moviesorseries!!**')
        print(e)
    try:
